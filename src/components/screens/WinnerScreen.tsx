  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center z-10 relative px-8">
        ...
        {name.corporation && (
          <p
            className="text-[26px]  font-bold uppercase text-center mt-2"
            style={{
              color: "#76BC21",
              fontFamily: "Lato",
              textShadow:
                "0px 4px 32px rgba(255, 255, 255, 1), 0px 4px 15px rgba(0, 0, 0, 0.1), -4px -4px 0 white, 4px -4px 0 white, -4px 4px 0 white, 4px 4px 0 white",
            }}
          >
            {name.corporation}
          </p>
        ...
        <div className="flex items-center justify-center text-center mt-8 max-w-[1315px]">
          <p
            className="text-[30px] font-bold uppercase leading-[1.3] flex flex-wrap items-center justify-center"
            style={{ color: "#6F47E5", fontFamily: "Lato" }}
          >
